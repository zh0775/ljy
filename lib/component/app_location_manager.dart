...
class AppLocationManager {
  ...
  regist({required Function(Map<String, Object> result) onLocationChanged}) {
    // if (!kIsWeb) {
    //   AMapFlutterLocation.updatePrivacyShow(true, true);
    //   AMapFlutterLocation.updatePrivacyAgree(true);
    //   AMapFlutterLocation.setApiKey(AMAP_KEY, "");
    //   requestPermission();
    //   locationListener =
    //       locationPlugin.onLocationChanged().listen(onLocationChanged);
    // }
  }
