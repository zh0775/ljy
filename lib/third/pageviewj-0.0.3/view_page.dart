...
import 'package:cxhighversion2/home/component/custom_pageview.dart';
...
class _PageViewJState extends State<PageViewJ> {
  ...
  Widget itemAniTransform(int index, BuildContext context) {
    Widget item = widget.items![index % widget.items!.length];
  ...
  double pageSafe(CustomPageController pageController) {
